...
//                      ForEach(vm.storyContents.indices, id: \.self) { idx in
//                          let content = vm.storyContents[idx]
//                          ZStack(alignment: .bottom) {
//                              // 1) The art
//                              Image(uiImage: vm.images[idx])
//                                  .resizable()
//                                  .aspectRatio(contentMode: .fill)
//                                  .frame(width: bookFrameWidth * 0.9,
//                                         height: bookContentHeightInsideFrame)
//                                  .clipped()
//                                  .cornerRadius(8)
//
//                              // 2) Bottom strip + overlay
//                              Rectangle()
//                                  .fill(localColors.softCream.opacity(0.85))
//                                  .frame(height: stripHeight)
//                                  .overlay(
//                                      Text(content.pageDisplayText)
//                                          .font(.system(size: stripHeight * 0.60,
//                                                         weight: .light,      // ← thin modern
//                                                         design: .default))
//                                          .multilineTextAlignment(.leading)
//                                          .lineSpacing(stripHeight * 0.05)
//                                          .lineLimit(2)
...
//                Button(action: {
//                    // Show the headshot & name sheet, instead of jumping straight to generation
...
//                // only now do we actually generate the storybook
//                generateStorybookWithPaywallCheck()
//            }) {
//                ProfileSetupView(
...
//            .onAppear {
//                // 🔥 TEST: load “old” as headshot
//                if headshotImage == nil, let test = UIImage(named: "old") {
//                  headshotImage      = test
//                  vm.subjectPhoto    = test
//                }
//                // 🔥 TEST: load your style‐tile
//                if vm.styleTile == nil, let style = UIImage(named: "kidsref") {
//                  vm.styleTile       = style
//                }
//                print("StoryPage appeared. Profile: \(profileVM.selectedProfile.name ?? "N/A")")
//
